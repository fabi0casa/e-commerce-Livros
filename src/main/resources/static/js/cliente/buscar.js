...
async function buscarLivros() {
    ...
    try {
        ...
        livros.forEach(livro => {
            ...
            card.href = `/anuncio?livroId=${livro.id}`; // OBS: precisa garantir que o DTO inclua `id`, senão remova isso
            card.classList.add("product-card-buscar");

            const categorias = livro.categorias.join(", ");
            ...
            card.innerHTML = `
                ...
                <div class="product-info">
                    ...
                    <div class="details">
                        <strong>Autor:</strong> ${livro.autor || "N/A"}<br>
