...
public class PageController {
    ...
    private static final Map<String, String> rotasPersonalizadas = Map.ofEntries(
        ...
        Map.entry("gerenciar-enderecos", "cliente/gerenciar/listarEndereco"),
        ...
        Map.entry("cadastrar-admin", "administrador/gerenciar-clientes/novoAdmin"),
    ...
    private static final Set<String> rotasAdmin = Set.of(
        ...
        "cartoes-cliente", "editar-cartao-cliente", "cadastrar-admin"
    );
